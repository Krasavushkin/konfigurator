...
export const CableDescription = ({data}: CableDescriptionType) => {
    ...
    const description = (data: CableConfigType) => {
        ...
        const individualScreen =  data.individualScreen === "эф" ?
            ", с индивидуальным экраном в виде ламинированной алюминиевой фольги" : data.individualScreen === "эфм" ?
                ", с индивидуальным экраном в виде ламинированной медной фольги" : data.individualScreen === "эо" ?
                    ", с индивидуальным экраном в виде оплетки из медных луженых проволок" : data.individualScreen === "эом" ?
